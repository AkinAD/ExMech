...
//
//
// currentNode = new JLabel("Current Position: " + derp.getKeyPhrase() + " "+
// '"' + derp.getData() + '"');
...
// btnPrev.getAccessibleContext().setAccessibleDescription("Navigates current
// list back to previous node");
// btnPrev.addKeyListener(enter); // Must be added to each button to execute it
// with the 'ENTER' key
// btnPrev.addActionListener(new ActionListener() {
// public void actionPerformed(ActionEvent e) {
// derp.prev();
//
// currentNode.setText("Current Position: " + derp.getKeyPhrase() + " "+ '"' +
// derp.getData() + '"');
// }
// });
...
// btnNext.getAccessibleContext().setAccessibleDescription("Navigates current
// list back to next node");
// btnNext.addKeyListener(enter); // Must be added to each button to execute it
// with the 'ENTER' key
...
// btnBranch.getAccessibleContext().setAccessibleDescription("Creates a new
// Branch from current list");
// btnBranch.addKeyListener(enter); // Must be added to each button to execute
...
// btnAdd.getAccessibleContext().setAccessibleDescription("Input new text into
// editor text box");
// btnAdd.addKeyListener(enter); // Must be added to each button to execute it
// with the 'ENTER' key
...
// menuBar.getAccessibleContext().setAccessibleDescription("Contains options
// relevant to program");
...
// mntmOpen.getAccessibleContext().setAccessibleDescription("Imports existing
// text file for editing in editor text box");
...
// mntmOpen.setAccelerator(KeyStroke.getKeyStroke('O', Toolkit.getDefaultToolkit
// ().getMenuShortcutKeyMask())); // Shortcut: Control + O
...
// mntmClear.setAccelerator(KeyStroke.getKeyStroke('C',
// Toolkit.getDefaultToolkit ().getMenuShortcutKeyMask())); // Shortcut: Control
// + C
...
// mntmSave.setAccelerator(KeyStroke.getKeyStroke('S', Toolkit.getDefaultToolkit
// ().getMenuShortcutKeyMask())); // Shortcut: Control + S
...
// } else {
// file = new File(file.toString() + ".txt"); // append .txt if "foo.jpg.txt" is
// OK
// file = new File(file.getParentFile(),
// FilenameUtils.getBaseName(file.getName())+".txt"); // ALTERNATIVELY: remove
// the extension (if any) and replace it with ".xml"
...
// boolean skip = false;
// while (skip == false) {
// int result = JOptionPane.showConfirmDialog(null, p, "My custom dialog",
...
// int i = JOptionPane.showOptionDialog(null, "Choose which branch to go to:",
// "Choose Button", JOptionPane.PLAIN_MESSAGE, 0, null,
